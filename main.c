...
int main()
{
    ...
    // unsigned char ciphertext[16] = {0x09, 0x12, 0x30, 0xaa, 0xde, 0x3e, 0xb3, 0x30, 0xdb, 0xaa, 0x43, 0x58, 0xf8, 0x8d, 0x2a, 0x6c};
    // unsigned char key2[16] = {0x47,0x70,0x44,0x9f,0x38,0xd7,0x18,0x3d,0xcc,0xbc,0x7b,0x7d,0x4b,0x38,0xe4,0xea}; 
    // print_plaintext(ciphertext);
    // test_dec(ciphertext, key2);
